...
function orgnk_frontend_enqueue_scripts() {
	...
	wp_enqueue_script( 'what-input', get_template_directory_uri() . '/js/libs/what-input.min.js', array('jquery'), SCRIPT_VERSION, true ); // v5.2.10
	wp_enqueue_script( 'modaal', get_template_directory_uri() . '/js/libs/modaal.min.js', array('jquery'), SCRIPT_VERSION, true ); // v0.4.4
	wp_enqueue_script( 'splide', get_template_directory_uri() . '/js/libs/splide.min.js', array(), SCRIPT_VERSION, true ); // v2.4.12
	wp_enqueue_script( 'orgnk-core', get_template_directory_uri() . '/js/orgnk-core-js/orgnk-core.min.js', array('jquery'), SCRIPT_VERSION, true );
	wp_enqueue_script( 'extras', get_template_directory_uri() . '/js/extras.min.js', array('jquery'), SCRIPT_VERSION, true );

	// Add CSS files
	wp_enqueue_style( 'main', get_template_directory_uri() . '/css/main.min.css', array(), SCRIPT_VERSION );
